 ...
 Citizen.CreateThread(function()
     while true do
         if Admin.showcoords then
             ...
             DrawTxt("~r~X:~w~ "..roundx,0.8355, 0.130)
             DrawTxt("~b~Y:~w~ "..roundy,0.8355, 0.160)
             DrawTxt("~g~Z:~w~ "..roundz,0.8355, 0.190)
             DrawTxt("~y~Angle:~w~ "..GetEntityHeading(PlayerPedId()),0.805, 0.220)
             drawRct2(0.80,0.128,0.2,0.13,0,0,0,255)
         end
         Citizen.Wait(0)
     end
 end)
		...
		Citizen.Wait(0)
			RageUI.IsVisible(main, true, true, true, function()
                ...
                if adminservice then
                    ...
                    RageUI.ButtonWithStyle("Facture - Coffre",nil, {RightLabel = "~y~25.000 ~s~$"}, true, function(_,_,s)
